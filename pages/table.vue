    ...
    <div class="table-pagging">
      <div class="pagging">
        <div class="pagging-btn">
          <BasePagging :current-page="currentPage" :total-page="totalPage" />
        </div>
        <div class="pagging-btn">
          <BaseButton @click="handleCreate">New Create</BaseButton>
        </div>
      </div>
    </div>
    <va-modal
...
const handleDelete = (index) => {
  dataItems.value = dataItems.value.filter((item, i) => i !== index);
};
const editItem = () => {
