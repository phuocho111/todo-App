export declare const VaDataTable: import("vue").DefineComponent<{
    ...
    onRowClickHandler: (name: "update:modelValue" | "scroll:bottom" | "update:sortBy" | "update:sortingOrder" | "filtered" | "sorted" | "selectionChange" | "row:click" | "row:dblclick" | "row:contextmenu" | "columnSorted" | "scroll:top", event: Event, row: import("./types").DataTableRow) => void;
