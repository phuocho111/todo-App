 ...
 */
export declare const useRangeModelValueGuard: (modelValue: Ref<DateInputModelValue>, disabled: Ref<boolean>, parseValue?: (date: DateInputModelValue) => import("../../va-date-picker/types").DatePickerModelValue) => {
