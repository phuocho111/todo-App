...
declare const _default: import("vue").DefineComponent<{
    ...
    dropdownIcon: {
        type: PropType<string | import("./types").SelectDropdownIcon>;
    ...
    rules: {
        ...
        type: PropType<import("../../composables").ValidationRule<SelectOption>[]>;
    };
    success: {
        type: BooleanConstructor;
        default: boolean;
    ...
    optionList: import("vue").ShallowRef<import("vue").DefineComponent<{
        ...
        optionGroups: Ref<Record<string, SelectOption[]>>;
    ...
    focusAutocompleteInput: (e?: Event) => void;
    ...
    visibleSelectedOptions: import("vue").ComputedRef<SelectOption[]>;
    ...
    getOptionByValue: (value: SelectOption) => SelectOption;
    compareOptions: (option1: SelectOption, option2: SelectOption) => boolean;
    getText: (option: SelectOption) => string;
    popupId: string;
    ...
    errorMessages: string | string[];
    errorCount: string | number;
    rules: import("../../composables").ValidationRule<SelectOption>[];
    immediateValidation: boolean;
    requiredMark: boolean;
    counter: boolean;
    maxLength: number;
