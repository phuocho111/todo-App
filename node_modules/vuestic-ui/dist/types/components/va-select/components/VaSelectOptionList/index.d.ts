export declare const VaSelectOptionList: import("vue").DefineComponent<{
    ...
    optionGroups: import("vue").Ref<Record<string, import("../..").SelectOption[]>>;
    ...
    handleMouseMove: (option: import("../..").SelectOption) => void;
    handleMouseEnter: (option: import("../..").SelectOption) => void;
