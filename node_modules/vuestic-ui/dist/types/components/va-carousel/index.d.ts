export declare const VaCarousel: import("vue").DefineComponent<{
    stateful: {
    ...
    vaImageProps: import("vue").ComputedRef<import("vue").ExtractPropTypes<Omit<{
        ratio: {
    ...
    doShowDirectionButtons: import("vue").ComputedRef<boolean>;
    getIndicatorEvents: (index: number) => {
        onmouseover: () => void;
        onclick?: undefined;
    } | {
        onclick: () => void;
    ...
    arrows: boolean;
    indicators: boolean;
    indicatorTrigger: "none" | "click" | "hover";
